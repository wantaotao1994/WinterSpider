...
{
    public class HttpUserAngent
    {

        public static readonly IList<string> PcUserAngent = new List<string>()
        {
        ...
        public static readonly IList<string> MobileUserAngent = new List<string>()
        {
